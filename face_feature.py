...
import architecture.inception_resnet_v1 as resnet
import numpy as np
...
class FaceFeature(object):
    def __init__(self, face_rec_graph, model_path = 'models/model-20170512-110547.ckpt-250000'):
        ...
        with face_rec_graph.graph.as_default():
            ...
            self.x = tf.placeholder('float', [None,182,182,3]); #default input for the NN is 160x160x3
    ...
    def get_features(self, input_imgs):
        images = load_data_list(input_imgs,182)
